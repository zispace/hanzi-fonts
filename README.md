...
>
> 另外，本仓库中文件不一定是最新版本，需要最新版、其他格式、其他字重的文件，可根据需要去官方渠道下载。

## 说明

- 目录结构：
  - `更多字体`：来自其他字库、个人开发或者开源的字体（满足常用繁简用字）
  - `补充字体`：补充一些字符数量不大（一万字符以内、繁简不兼容）但有特色的字体
  - `港台繁体`：补充港台繁体标准的字体文件
- 字体文件统计信息可参见 [字体信息统计](./字体信息统计.tsv)；
- 字体原始来源（部分）可参考 [字体来源资料](./字体来源资料.tsv)。
- 相关仓库：
  - 中文字体收集 [:link: zispace/hanzi-fonts-ext](https://github.com/zispace/hanzi-fonts-ext/) ![][hanzi-fonts-ext-commit]
  - 常见超大字符集 CJK 字体 [:link: zispace/hanzi-fonts-ultra](https://github.com/zispace/hanzi-fonts-ultra/) ![][hanzi-fonts-ultra-commit]
...
- 更多中文字体资料可参考
  ...
  - [suyanali/blog | 字型總集.md](https://github.com/suyanali/blog/blob/main/post/fonts/字型總集.md) ![][suyanali-commit]
  - [Warren2060/FreeFontCollection](https://github.com/Warren2060/FreeFontCollection/) ![][freefontcollection-commit] 年度中文、西文字体评测
...
除了操作系统（PC/MAC/手机）自带系统，可以使用手机厂商等联合开发的字体：

- 华为鸿蒙 HarmonyOS Sans [官网](https://developer.huawei.com/consumer/cn/design/resource-V1/) [github 镜像](https://github.com/huawei-fonts/HarmonyOS-Sans)
  - [HarmonyOS-Sans.zip](https://developer.huawei.com/images/download/general/HarmonyOS-Sans.zip)
- 小米 MiSans / MiSans L3 [官网](https://hyperos.mi.com/font/download) [github Web 版本](https://github.com/dsrkafuu/misans)
  - [MiSans.zip](https://hyperos.mi.com/font-download/MiSans.zip)
  - [MiSans_L3.zip](https://hyperos.mi.com/font-download/MiSans_L3.zip)
  - [MiSans_Latin.zip](https://hyperos.mi.com/font-download/MiSans_Latin.zip)
  - [MiSans_Global_ALL.zip](https://hyperos.mi.com/font-download/MiSans_Global_ALL.zip)
- OPPO Sans [官网](https://www.coloros.com/article/A00000074/)
  - [OPPO_Sans_4.0.zip](https://coloros-website-cn.allawnfs.com/font/OPPO_Sans_4.0.zip)
  - [OPPOSans3.0.zip](https://coloros-website-cn.allawnfs.com/font/OPPOSans3.0.zip)
- Vivo Sans / Vivo Sans L3 [官网](https://developers.vivo.com/doc/d/314fa33cbaec4a93be351cd44757d9d9)
  - [vivo Sans.zip](https://developersstatic.vivo.com/developers/1cdcaef3b39848f290bf90346642ed1d/20241022/vivo%20Sans.zip)
- 荣耀 Honor Sans [官网](https://developer.honor.com/cn/doc/guides/100681)
  - [HONOR_Sans_1.2.zip](https://contentplatform-drcn.hihonorcdn.com/developerPlatform/HONOR_Sans_1.2/HONOR_Sans_1.2.zip)
- 阿里巴巴普惠体 3.0 [官网](https://www.alibabafonts.com/#/font)
  - [AlibabaPuHuiTi-3.zip](https://fonts.alibabadesign.com/AlibabaPuHuiTi-3.zip)
  - [AlibabaPuHuiTi-2.zip](https://fonts.alibabadesign.com/AlibabaPuHuiTi-2.zip)
  - [AlibabaSans.zip](https://fonts.alibabadesign.com/AlibabaSans.zip) Latin W1G 规格的拉丁字库
  - [AlibabaSansItalics.zip](https://fonts.alibabadesign.com/AlibabaSansItalics.zip)

或者使用网友 `远景论坛@碧海潮声` [原版雅黑、修正版雅黑、鸿蒙替换雅黑](https://bbs.pcbeta.com/viewthread-1960120-1-1.html) 整合改进字体包。

<details>
<summary>Github macos 字体包</summary>

- [:link: sahibjotsaggu/San-Francisco-Pro-Fonts](https://github.com/sahibjotsaggu/San-Francisco-Pro-Fonts) ![](https://img.shields.io/github/stars/sahibjotsaggu/San-Francisco-Pro-Fonts?style=flat-square)
- [:link: AppleDesignResources/SanFranciscoFont](https://github.com/AppleDesignResources/SanFranciscoFont) ![](https://img.shields.io/github/stars/AppleDesignResources/SanFranciscoFont?style=flat-square)
- [:link: fefelixa/macfonts](https://github.com/fefelixa/macfonts) ![](https://img.shields.io/github/stars/fefelixa/macfonts?style=flat-square)
...
<details>
<summary>Github windows/office 字体包</summary>

- [:link: pjobson/Microsoft-365-Fonts](https://github.com/pjobson/Microsoft-365-Fonts) ![](https://img.shields.io/github/stars/pjobson/Microsoft-365-Fonts?style=flat-square)
- [:link: jlxd/Noble-Scarlet-mod](https://github.com/jlxd/Noble-Scarlet-mod) ![](https://img.shields.io/github/stars/jlxd/Noble-Scarlet-mod?style=flat-square)
- [:link: pjobson/Microsoft-Fonts](https://github.com/pjobson/Microsoft-Fonts) ![](https://img.shields.io/github/stars/pjobson/Microsoft-Fonts?style=flat-square)
- [:link: MauCariApa-com/windows-11-fonts](https://github.com/MauCariApa-com/windows-11-fonts) ![](https://img.shields.io/github/stars/MauCariApa-com/windows-11-fonts?style=flat-square)
...
- [freefonts.space | 免费商用字体库](https://freefonts.space/) [figma](https://www.figma.com/community/file/1256555346586156735/https-freefonts-space/)
- [gentleflow.tech | 开源中文字体](https://font.gentleflow.tech)
...
以及设计类软件：Adobe Illustrator、Adobe Photoshop、Adobe XD、Figma、Sketch
...
- [52pojie.cn](https://www.52pojie.cn/thread-1829462-1-1.html) 将 win11 全局字体替换软件【System Fonts Replacer】

### 其他工具

- [:link: NightFurySL2001/CJK-character-count](https://github.com/NightFurySL2001/CJK-character-count/) 字符统计
...
- [:link: Honoka55/font-counter](https://github.com/Honoka55/font-counter/) 字符统计
...
- [:link: moi15moi/FindSystemFontsFilename](https://github.com/moi15moi/FindSystemFontsFilename) 查询系统字体名称（python）
  ![](https://img.shields.io/github/stars/moi15moi/FindSystemFontsFilename?style=flat-square)
  ![](https://img.shields.io/github/v/release/moi15moi/FindSystemFontsFilename?style=flat-square)
- [:link: awesometoolbox/otf2ttf](https://github.com/awesometoolbox/otf2ttf) 利用 fonttools 将 OTF 字体转化成 TTF（python）
  ![](https://img.shields.io/github/stars/awesometoolbox/otf2ttf?style=flat-square)
- [identifont.com](http://www.identifont.com/index.html) 查询相似字体等
...
- `IPA Font License Agreement`(**IPA**)：日本信息处理推进机构（IPA）发布的一种开源字体许可证，在日本字体中常见，理念接近 OFL。 [IPA FONT LICENSE AGREEMENT V1.0](https://moji.or.jp/ipafont/license/)
